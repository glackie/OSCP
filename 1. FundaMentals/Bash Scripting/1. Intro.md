...
```shell-session
chocolateeboi@htb[/htb]$ bash script.sh <optional arguments>
```

Script Execution - Examples

```shell-session
chocolateeboi@htb[/htb]$ sh script.sh <optional arguments>
```

Script Execution - Examples

```shell-session
chocolateeboi@htb[/htb]$ ./script.sh <optional arguments>
```
...
```shell-session
chocolateeboi@htb[/htb]$ ./CIDR.sh inlanefreight.com
